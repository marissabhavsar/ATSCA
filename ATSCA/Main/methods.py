...
def set_up_ChatGPT(calendar, tasks):
    os.environ["OPENAI_API_KEY"] = "sk-proj-n7sa3xBZiaG7tSnAIlsvT3BlbkFJmqrLNWns4dU7N3GpV6Xk"
    client = OpenAI()
    client.api_key = "sk-proj-n7sa3xBZiaG7tSnAIlsvT3BlbkFJmqrLNWns4dU7N3GpV6Xk"
...
def set_up_ChatGPT_streamlit(calendar, tasks):
    os.environ["OPENAI_API_KEY"] = "sk-proj-n7sa3xBZiaG7tSnAIlsvT3BlbkFJmqrLNWns4dU7N3GpV6Xk"
    client = OpenAI()
    client.api_key = "sk-proj-n7sa3xBZiaG7tSnAIlsvT3BlbkFJmqrLNWns4dU7N3GpV6Xk"
